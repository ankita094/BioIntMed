#CODE4---To filter the attribute value from clinical trial for serious adverse Events----
...
outFileName1 = OUTPUT_PATH + "trialSeriousEvent1.csv"
outFileName2 = OUTPUT_PATH + "countSeriousEvent1.csv"
		...
		for name in files:
		    ...
		    for key,value in data.items():
			    	...
			    	try:
			    		...
			    		if data['clinical_study']["clinical_results"]["reported_events"]["serious_events"]["category_list"]["category"]:
			    			for loc in data['clinical_study']["clinical_results"]["reported_events"]["serious_events"]["category_list"]["category"]:
			    				val2 = loc["title"]
				    			if val2 != "Total":
