#CODE1---To filter the attribute value from clinical trial for drug invention after converting the files from xml to json----
...
outFileName1 = OUTPUT_PATH + "mainClinical1.csv"
...
if __name__ == "__main__":
	...
	with open(outFileName1,"w",encoding='utf8') as csv_file:
		...
		writer.writerow(["clinical_id","title","brief_description","description","phase","study_type","gender","min_age","max_age","intervention_model","primary_purpose","masking","condition","intervention","receive_date","result_first","last_updated","last_verified","start_date","completion_date","sponsor"])
		for name in files:
		    data = jsonRead(name)
		    for key,value in data.items():
			    	...
			    	writer.writerow([val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val21,val14,val15,val16,val17,val18,val19,val20])
		print("---------------------------------------")
csv_file.close()
