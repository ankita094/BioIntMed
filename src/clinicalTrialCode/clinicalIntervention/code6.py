#CODE6---To filter the attribute value from clinical trial for all conditions----
...
outFileName1 = OUTPUT_PATH + "condition1.csv"
outFileName2 = OUTPUT_PATH + "countCondition1.csv"
