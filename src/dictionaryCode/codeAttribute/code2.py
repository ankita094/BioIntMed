#CODE2---To extract for drug data for the main drug table----
#Spark version 2.3.1
...
#--------------CODE2--------------
#For formation of classification table
outFileName1 = OUTPUT_PATH + "DRUG_CLASSIFICATION.csv"

#Part extracting for main drug attribute
df1 = df.select(df['drugbank-id']['_VALUE'][0],df['name'],df['classification']['direct-parent'],\
  df['classification']['kingdom'],df['classification']['superclass'],df['classification']['class'],df['classification']['subclass'])
df1.show()
