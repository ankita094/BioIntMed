#CODE10---To extract for drug data for the main drug table----
#Spark version 2.3.1
...
#-----------CODE10----------------
#interaction file for relation extraction part
#Part executing for drug interaction
outFileName8 = OUTPUT_PATH + "drugInteractionRel.csv"
...
df_split2.show()
df_split2.toPandas().to_csv(outFileName8,sep='\t', index=False,encoding='utf-8')
